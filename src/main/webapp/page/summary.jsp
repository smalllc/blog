...
<body style="background:url(${pageContext.request.contextPath}/images/bj.png) repeat top left scroll">
	...
	<article>
		...
		<div class="rightbox">
			...
			<div class="fenlei animated fadeInUp">
		      <h2 class="cloud_hometitle">分类</h2>
		      <ul >
		        
		      </ul>
   			 </div>
   			 <div class="zhuanti animated fadeInUp">
		      <h2 class="cloud_hometitle">专题</h2>
		      <ul>
		        
		      </ul>
		    </div>
   			 
			<div class="tuijian2 animated fadeInUp" style="display:none">
			...
			<div class="dj dianji paihang animated fadeInUp" style="display:none;">
	...
	<script src="${pageContext.request.contextPath}/js/page/summary.min.js"></script>
