			...
			<div class="infos">
				<div class="newsview">
					...
					<div class="news_infos m20 animated fadeIn">
						...
						<br>
						<p>域名：www.smallcc.com</p>
						<p>服务器：阿里云服务器</p>
						<p>备案号：蜀ICP备18001827号-1</p>
						<p>程序：Java</p>
						<a target= "_blank" href="http://www.smallcc.com/find/13015.html"><span style="color: #12aae8;font-size: 13px;">查看更多</span></a>
					</div>
				</div>
			</div>
		</div>
