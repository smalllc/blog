...
var pageNext=1;
	...
	$(window).scroll(function(){
    	...
    	if($(document).scrollTop()>1700&&width>700){
	...
	var initBlogType=function(){
		...
		$.ajax({
            ...
            success:function (data) {
                ...
                for (var i = 0; i < data.length; i++) {
                	var time=i*0.03;
                	// <li style="animation-delay:'+time+'s" class="animated fadeInDown" style="animation-delay:'+time+'s" class="animated fadeInDown"><a style="padding: 5px;margin-right: 3px;border: none; background-color: #f1f1f1;" onclick="searchType('+data[i].id+',\''+data[i].typename+'\')" href="javascript:void(0);"> <i class="fa fa-tag"></i>'+data[i].typename+'</a></li>
                	typeName+='<a style="animation-delay:'+time+'s" class="animated fadeInDown" onclick="searchType('+data[i].id+',\''+data[i].typename+'\')" href="javascript:void(0);">'+data[i].typename+'</a> '
                }
                var length='';
                var keyTitle='';
                if(data.length>5){
