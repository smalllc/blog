						...
						success : function(dataAll) {
							...
							for (var i = 0; i < data.length; i++) {
								...
								newBlog += '<li style="animation-delay:0.'+i+'s" class="animated fadeInDown"><h3 class="blogtitle"><a href="find/'+id+'.html"  >'
										...
										+ data[i].introduction
										+ '</p></div><div class="autor"><span style="float:left;padding:0;color: #38485a"><i class="fa fa-user" style="color: #88827dcc;"></i>&nbsp;罗小川</span><span class="lm f_l"><a href="javascript:void(0);">'
										+ keyword
